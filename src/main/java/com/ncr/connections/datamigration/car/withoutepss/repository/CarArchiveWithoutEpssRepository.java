package com.ncr.connections.datamigration.car.withoutepss.repository;
...
public interface CarArchiveWithoutEpssRepository extends JpaRepository<CarArchive, Long> {
